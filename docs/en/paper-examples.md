...
**Design:** Three-phase reinforcer-revaluation paradigm for free-operant avoidance. (1) Acquisition under a Sidman schedule with a feedback stimulus contingent on responding. (2) Revaluation: non-contingent shock presentations paired (or unpaired) with a systemic drug treatment, in the absence of the lever. (3) Extinction test in the original avoidance schedule without reinforcer delivery. The authors interpret the procedure within the goal-directed / habitual framework of Adams and Dickinson (1981): under that framework, if the test-phase responding is goal-directed, the revaluation manipulation should change the test-phase response rate; if the responding has become habitual, the revaluation manipulation should not change it. The DSL represents only the procedural arrangement; the goal-directed / habitual framework is the authors' theoretical motivation, not a commitment of the DSL.
