...
- `schema/composed/*.schema.json` — 手続き別の合成スキーマ（conditioned-suppression、pit、autoshaping、omission、two-process-theory）
- `schema/experiment/phase-sequence.schema.json` — Experiment 層
