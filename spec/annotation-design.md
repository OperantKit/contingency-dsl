...
| **Measurement** | measurement-annotator (v1.x minimal set) | `@session_end`, `@baseline`, `@steady_state` |
...
3. **境界判定が明確**: 4 カテゴリに収まらないものは `extensions/` 配下に置くか、
   [Schedule Extension 層](ja/design-philosophy.md#5-schedule-extension-%E5%B1%A4--%E5%8B%95%E7%9A%84tc-%E8%BF%91%E5%82%8D%E3%81%AE-schedule-%E6%A7%8B%E6%88%90%E7%B4%A0)
   で扱うかの決定が明示的になる
